    ...
    <div class="elog-panel__body">
        ...
        <form class="training-filters" method="get" action="dashboard.php">
            ...
            <div class="training-filters__actions">
                ...
                <a class="btn btn--grey" href="dashboard.php?tab=rotational&amp;sub=list&amp;program=<?= htmlspecialchars($program ?? '') ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn--view"
                               href="dashboard.php?tab=rotational&amp;sub=view&amp;id=<?= (int) $row['id'] ?>&amp;program=<?= htmlspecialchars($program ?? '') ?>"
                               title="View entry">
