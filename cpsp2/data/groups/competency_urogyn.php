...
/**
 * CPSP FCPS – UROGYNAECOLOGY competency tree.
 * Specific to the UROGYNAECOLOGY (FCPS) logbook program.
 * Groups and competencies as per CPSP urogynaecology curriculum.
 *
...
return [
    ...
    [
        'id'       => 401,
        'label'    => 'Urogynaecology - Clinical Assessment (OPD & Ward)(IMM)',
        'children' => [
    ...
    [
        'id'       => 402,
        'label'    => 'Urinary Incontinence Assessment & Management (IMM)',
        'children' => [
    ...
    [
        'id'       => 403,
        'label'    => 'Pelvic Organ Prolapse (POP) – Assessment & Conservative Mx (IMM)',
        'children' => [
    ...
    [
        'id'       => 405,
        'label'    => 'Fistulae – Assessment & Initial Management (IMM)',
        'children' => [
    ...
    [
        'id'       => 406,
        'label'    => 'Defaecatory Dysfunction & Anorectal Disorders (IMM)',
        'children' => [
    ...
    // ─── Part-II (FCPS-II) Groups ────────────────────────────────────────────────
    [
        'id'       => 407,
        'label'    => 'Urogynaecology – Operative Skills (General)(FCPS - II)',
        'children' => [
    ...
    [
        'id'       => 408,
        'label'    => 'Incontinence Surgery (FCPS - II)',
        'children' => [
    ...
    [
        'id'       => 409,
        'label'    => 'Pelvic Organ Prolapse Surgery (FCPS - II)',
        'children' => [
    ...
    [
        'id'       => 411,
        'label'    => 'Cystoscopy & Endoscopic Procedures (FCPS - II)',
        'children' => [
    ...
    [
        'id'       => 412,
        'label'    => 'Anorectal & Pelvic Floor Reconstruction (FCPS - II)',
        'children' => [
    ...
    [
        'id'       => 413,
        'label'    => 'Neurogenic Bladder & Special Situations (FCPS - II)',
        'children' => [
