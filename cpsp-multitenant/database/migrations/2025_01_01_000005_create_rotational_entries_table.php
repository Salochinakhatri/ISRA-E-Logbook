...
return new class extends Migration
{
    ...
    {
        Schema::create('rotational_entries', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('rot_ids')->nullable();
            $table->json('rot_detail_ids')->nullable();
    ...
    {
        Schema::dropIfExists('rotational_entries');
    }
};
