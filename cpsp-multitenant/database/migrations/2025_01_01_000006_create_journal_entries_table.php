...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('journal_entries', function (Blueprint $table) {
            ...
            $table->date('date_of_diss')->nullable();
            $table->string('fac_by', 255)->default('');
            // cpsp1 field: full combined reference
            $table->text('ref_of_art_disc')->nullable();
            // cpsp2 fields: separate topic + ref_article
            $table->string('topic', 500)->default('');
            $table->string('ref_article', 500)->default('');
