    ...
    <div class="elog-panel__body">
        <form class="training-filters" method="get" action="dashboard.php">
            ...
            <div class="training-filters__actions">
                ...
                <a class="btn btn--grey" href="dashboard.php?tab=training&amp;sub=list"><i class="fa-solid fa-list"></i> Show all</a>
    ...
    <table class="elog-table">
        <thead>
            <tr>
                ...
                <th>Competancy Group/Details</th>
                <th>Level</th>
                <th>Entry Status</th>
                <th>Actions</th>
            </tr>
            ...
            <?php else: ?>
                <?php foreach ($entries as $i => $row): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn--view" href="dashboard.php?tab=training&amp;sub=view&amp;id=<?= (int) $row['id'] ?>" title="View"><i class="fa-solid fa-eye"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
