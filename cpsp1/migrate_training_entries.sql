-- Run this if you already have cpsp_eportal without training_entries (no need to re-import full database.sql).
-- Usage: mysql -u root cpsp_eportal < migrate_training_entries.sql
